...
Welcome to ``gklr`` contributor's guide.
...
If you experience bugs or general issues with ``gklr``, please have a look
...
You can help improve ``gklr`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``gklr`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``gklr``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n gklr python=3 six virtualenv pytest pytest-cov
    conda activate gklr
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/gklr.git
    cd gklr
...
#. Install |pre-commit|_::
   ...
   ``gklr`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/gklr
.. _issue tracker: https://github.com/<USERNAME>/gklr/issues
.. <-- end -->
